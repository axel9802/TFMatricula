...
namespace Presentacion
{
    public partial class FrmCrearAlumno : Form
    {
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (nom != "" && ape != "" && cor != "")
                {
                        ...
                        if (dni > 10000000 && dni < 99999999)
                        {
                            if (cod > 10000 && cod < 99999)
                            {
                                if (con > 10000 && con < 99999)
                                {
                                    ...
                                    user.Correo = cor;
                                    user.Contra = con;
                                    geUsu.RegistrarAlumno(user);
                                    MessageBox.Show("Alumno registrado correctamente", "Listo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                    listarUsuarios();
                                    Limpiar();
                                }
                                else
                    ...
                    {
                        MessageBox.Show("El usuario ya existe, por favor ingrese otros datos", "Error", MessageBoxButtons.RetryCancel, MessageBoxIcon.Error);
                    }
                }
                else
                {
        ...
        {
            dgUusarios.DataSource = geUsu.listarAlumnos();
        }
        ...
        private void FrmCrearAlumno_Load(object sender, EventArgs e)
        {
            listarUsuarios();
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Alumno eliminado correctamente", "Listo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                listarUsuarios();
                Limpiar();
                Habilitar();
            }
