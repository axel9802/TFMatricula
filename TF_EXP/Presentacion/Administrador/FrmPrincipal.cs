...
namespace Presentacion
{
    public partial class FrmPrincipal : Form
    {
        ...
        public FrmPrincipal(eUsuario uPrin)
        {
            user = uPrin;
            InitializeComponent();
        ...
        private void btnAsignaProfe_Click(object sender, EventArgs e)
        {
            abrirFormulario(new FrmAsignarProfe());
            lbltitulo.Text = "Asignar Cursos a Profesor";
        }

        private void btnDatos_Click(object sender, EventArgs e)
        {
            abrirFormulario(new FrmDatos(user));
            lbltitulo.Text = "Datos del " + user.Tipo;
        }

        private void btnAsignaAlumno_Click(object sender, EventArgs e)
        {
            abrirFormulario(new FrmAsignarAlumno());
            lbltitulo.Text = "Asignar Alumno";
        }

        private void btnCrearCurso_Click(object sender, EventArgs e)
        {
            abrirFormulario(new FrmCrearCurso());
            lbltitulo.Text = "Crear Curso";
        }
        ...
        {
            abrirFormulario(new FrmCrearProfesor());
            lbltitulo.Text = "Crear Profesor";
        }

        private void btnAlumnos_Click(object sender, EventArgs e)
        {
            abrirFormulario(new FrmCrearAlumno());
